...
class CpufragAdapter(private val cpuproducts: List<PcBundle>) : RecyclerView.Adapter<CpufragAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val textView1: TextView = itemView.findViewById(R.id.productNameTextView4)
        val textView2: TextView = itemView.findViewById(R.id.descriptionTextView4)
    }
}