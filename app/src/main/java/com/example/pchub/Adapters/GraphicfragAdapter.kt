...
class GraphicfragAdapter(private val cpuproducts: List<PcBundle>) : RecyclerView.Adapter<GraphicfragAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        val imageView: ImageView = itemView.findViewById(R.id.imagegraphic)
        val textView1: TextView = itemView.findViewById(R.id.productNameTextView7)
        val textView2: TextView = itemView.findViewById(R.id.descriptionTextView7)
    }
}