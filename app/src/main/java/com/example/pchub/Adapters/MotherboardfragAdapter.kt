...
class MotherboardfragAdapter(private val cpuproducts: List<PcBundle>) : RecyclerView.Adapter<MotherboardfragAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        val imageView: ImageView = itemView.findViewById(R.id.imagemotherboard1)
        val textView1: TextView = itemView.findViewById(R.id.productNameTextView5)
        val textView2: TextView = itemView.findViewById(R.id.descriptionTextView5)
    }
}